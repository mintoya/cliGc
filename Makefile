CFLAGS = -pthread
OBJECTS = wprint/wprint.c main.c draw/draw.c tSize/terminal_size.c list/list.c layers/leyers2.c input/input.c template/template.c
make: $(OBJECTS)
